...
file_name <- paste(dl_folder, "data", "bronze", "ec", paste0("consumer_total_nsa_nace2", ".zip"), sep = "/")
...
tfile <- tempfile(tmpdir = tdir <- tempdir())
file_name <- paste(dl_folder, "data", "bronze", "ec", paste0("consumer_total_sa_nace2", ".zip"), sep = "/")
zipped_files <- unzip(file_name, exdir = tdir)
